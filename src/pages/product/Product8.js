  ...
  return (
    ...
    <section id="prodetails" className="section-p1" style={{paddingBottom: '10%'}}>
        ...
        <div className="single-pro-details">
          ...
          <ul className="uls"><li>{t("p8ul1")}</li><li>{t("p8ul2")}</li><li>{t("p8ul3")}</li><li>{t("p8ul4")}</li><li>{t("p8ul5")}</li><li>{t("p8ul6")}</li><li>{t("p8ul7")}</li><li>{t("p8ul8")}</li><li>{t("p8ul9")}</li><li>{t("p8ul10")}</li><li>{t("p8ul11")}</li><li>{t("p8ul12")}</li><li>{t("p8ul13")}</li></ul>
